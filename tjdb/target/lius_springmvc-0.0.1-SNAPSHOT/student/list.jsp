		        ...
		        <c:forEach items="${data.pageList}" var="list" varStatus="st">
		        	<tr>
				        ...
				        <td> 
				        	...
				        	<a href="javascript:void(0);" onclick="operate('open_lesson','${list.id}')" class="tablelink">选课</a>
				        	<a href="javascript:void(0);" onclick="operate('open_pwd','${list.id}')" class="tablelink">修改密码</a>    
				        	<a href="javascript:void(0);" class="tablelink" onclick="operate('delStudent','${list.id}')"> 删除</a>
				        </td>
			        </tr>
		        </c:forEach>
	        </tbody>
